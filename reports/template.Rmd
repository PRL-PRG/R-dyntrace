...
if(print_data) print(force.histogram %>% as.data.frame %>% transform(number=pp(number)), row.names=FALSE)
```
</div>
...
if(print_data) print(promise.evaluation.histogram_with_labels %>% as.data.frame %>% transform(number=pp(number)), row.names=FALSE)
```
<!--/div-->
</div>
...
if(print_data) print(force.histogram.by.type %>% as.data.frame %>% transform(number=pp(number)), row.names=FALSE)
```
</center>
...
if (print_data) print(promise.lifestyles %>% as.data.frame %>% transform(number=pp(number)), row.names=FALSE)
```
</center>
<!--/div-->
...
if(print_data) print(histogram_with_labels %>% as.data.frame %>% transform(number=pp(number)), row.names=FALSE)
...
if(print_data) print(promise.types %>% as.data.frame %>% transform(number=pp(number)), row.names=FALSE)
```
</div>
...
if(print_data) print(promise.full.types %>% as.data.frame %>% transform(number=pp(number)), row.names=FALSE)
```
<!--/div-->
</div>
...
if(print_data) print(calls.types %>% as.data.frame %>% transform(number=pp(number)), row.names=FALSE)
```
</div>
...
if(print_data) print(calls.functions %>% as.data.frame %>% transform(number=pp(number)), row.names=FALSE)
```
</div>
...
if(print_data) print(closure.call.compilation.histogram %>% as.data.frame %>% transform(number=pp(number)), row.names=FALSE)
```
<div class="together">
...
if(print_data) print(closure.function.compilation.histogram %>% as.data.frame %>% transform(number=pp(number)), row.names=FALSE)
```
<!--/div-->
</div>
...
get_function_calls("^<anonymous>$", "eval", "force", "delayAssign", "return") %>% data.frame %>% transform(number=pp(number)) %>% print(., row.names=FALSE)
```
