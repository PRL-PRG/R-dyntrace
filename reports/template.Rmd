...
A function is **strict** if all of its calls are **strict**.
...
par(mar=c(0,2,2,2))
pie(strict.calls.histogram$number, strict.calls.histogram$strict, main="Call strictness")
...
par(mar=c(2,2,2,2))
barplot(strict.calls.rate.histogram$number, names.arg=strict.calls.rate.histogram$strictness_rate, space=0, main="Call strictness (rate of evaluated promises)")
...
par(mar=c(2,2,2,2))
barplot(strict.calls.ratio.histogram$number, names.arg=strict.calls.ratio.histogram$strictness_ratio, space=0, main="Call strictness (ratio of evaluated promises)")
````
</center>

<center>
``` {r strict-functions, echo=FALSE, comment="", fig.width=12, fig.height=4.5}
par(mar=c(2,2,2,2))
barplot(strict.functions.histogram$number, names.arg=strict.functions.histogram$strictness_rate, space=0, main="Function strictness (rate of strict calls)")
````
</center>
...
<div class="together">
#### Call Strictness
```{r strict-calls-print, echo=FALSE, comment="", fig.width=12, fig.height=4.5}
...
#### Function Strictness
```{r strict-functions-print, echo=FALSE, comment="", fig.width=12, fig.height=4.5}
