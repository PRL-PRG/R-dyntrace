...
if(print_data) print(force.histogram %>% as.data.frame, row.names=FALSE)
```
</div>
...
if(print_data) print(promise.evaluation.histogram_with_labels %>% as.data.frame, row.names=FALSE)
```
<!--/div-->
</div>
...
if(print_data) print(force.histogram.by.type %>% as.data.frame, row.names=FALSE)
```
</center>
...
if (print_data) print(promise.lifestyles %>% as.data.frame, row.names=FALSE)
```
</center>
<!--/div-->
...
if(print_data) print(histogram_with_labels %>% as.data.frame, row.names=FALSE)
...
if(print_data) print(promise.types %>% as.data.frame, row.names=FALSE)
```
</div>
...
if(print_data) print(promise.full.types %>% as.data.frame, row.names=FALSE)
```
<!--/div-->
</div>
...
if(print_data) print(closure.call.compilation.histogram %>% as.data.frame, row.names=FALSE)
```
<div class="together">
...
if(print_data) print(closure.function.compilation.histogram %>% as.data.frame, row.names=FALSE)
```
<!--/div-->
</div>
